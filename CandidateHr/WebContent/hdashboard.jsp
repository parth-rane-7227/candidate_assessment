...
<div class="brand">
   ...
   <marquee direction="Scroll" scrollamount="10" behaviour="alternate"><h1 style="color: white;font-family:helvetica;"><b><h1><strong><em>HR View</em></strong></h1></b></h1></marquee>
        ...
        <!-- user login dropdown start-->
         <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                ...
                <span class="username"><%= values.getHname() %></span>
                <b class="caret"></b>
            </a> 
...
<img src="candidate.png" width=1530px height=960px>
<!--sidebar end-->
