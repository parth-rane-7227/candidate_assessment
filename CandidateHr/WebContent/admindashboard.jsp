...
<div class="brand">
 ...
 <div class="w3-container w3-center w3-animate-left">
   <marquee direction="Scroll" scrollamount="10" behaviour="alternate"><h1 style="color: white;font-family:helvetica;"><b><h1><strong><em>Admin View</em></strong></h1></b></h1></marquee>
 <!--  <p>The w3-animate-left class slides in an element from left.</p> -->
  ...
  <!-- <a href="#" class="logo">
 <div class="w3-container w3-center w3-animate-left">
   <strong><em>Admin View</em></strong>
  <p>The w3-animate-left class slides in an element from left.</p>
</div>
</a> -->
<!--logo end-->
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="adminlogo.png">
                <span class="username"><%= values.getAname() %></span>
                <b class="caret"></b>
            </a>
...
<img src="admin3.png" width=1530px height=900px>
<!--sidebar end-->
